...
coins.forEach(function (coin) {
  ...
  coin.main.toRavencoinJS = toRavencoinJS.bind(coin.main)
  coin.main.toRavencore = toRavencore.bind(coin.main)
  supportedCoins[unit] = coin.main
  supportedCoins[name] = coin.main

  if (coin.test) {
    coin.test.testnet = true
    coin.test.toRavencoinJS = toRavencoinJS.bind(coin.test)
    coin.test.toRavencore = toRavencore.bind(coin.test)
  ...
  if (coin.regtest) {
    ...
    coin.regtest.toRavencoinJS = toRavencoinJS.bind(coin.regtest)
    coin.regtest.toRavencore = toRavencore.bind(coin.regtest)
